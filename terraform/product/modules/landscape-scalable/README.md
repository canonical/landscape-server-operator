...
| Name | Type |
|------|------|
| [juju_application.haproxy_certs](https://registry.terraform.io/providers/juju/juju/latest/docs/resources/application) | resource |
...
| <a name="input_haproxy_certs"></a> [haproxy\_self\_signed\_certs](#input\_haproxy\_self\_signed\_certs) | Configuration for the self-signed-certificates charm used by HAProxy. Set to null to skip deployment. | <pre>object({<br/>    app_name    = optional(string, "self-signed-certificates")<br/>    channel     = optional(string, "1/stable")<br/>    constraints = optional(string, "arch=amd64")<br/>    revision    = optional(number)<br/>    base        = optional(string, "ubuntu@24.04")<br/>  })</pre> | `{}` | no |
