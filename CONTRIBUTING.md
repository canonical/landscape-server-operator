...
To deploy Landscape using the product Terraform module with a modern (26.04+) configuration instead of a bundle, use:
...
To deploy the legacy (24.04) configuration instead:

```sh
make deploy-landscape-scalable-legacy
```
